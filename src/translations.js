export const translations = {
  es: {
    ...
    projects: {
      ...
      link: "Enlace:",
      visit: "Visitar Sitio",
      current: "Estás navegando en este proyecto actualmente.",
      data: [
        {
          id: 3,
    ...
    contact: {
      title: "Contáctame",
      subtitle: "¿Tienes un proyecto en mente o una vacante? ¡Hablemos!",
      name: "Nombre",
      email: "Email",
      message: "Mensaje",
      send: "Enviar Mensaje",
  ...
  en: {
    ...
    projects: {
      ...
      link: "Link:",
      visit: "Visit Site",
      current: "You are currently browsing this project.",
      data: [
        {
          id: 3,
    ...
    contact: {
      title: "Contact Me",
      subtitle: "Have a project in mind or a vacancy? Let's talk!",
      name: "Name",
      email: "Email",
      message: "Message",
      send: "Send Message",
